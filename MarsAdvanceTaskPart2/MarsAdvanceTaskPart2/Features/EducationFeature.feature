...
Scenario: Add Education
	...
	And I navigate to education tab of profile page
	When I reset the existing entries
	And I add education from file located at "C:\internship notes\MarsAdvanceTaskPart2\MarsAdvanceTaskPart2\MarsAdvanceTaskPart2\MarsAdvanceTaskPart2\TestData\AddEducationTestData.json"
